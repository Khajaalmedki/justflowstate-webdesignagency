  ...
  return (
    <div className="w-full">
      ...
      <input
        ref={ref}
        className={cn(
          'w-full bg-[#1A1A1B] border border-[#2A2B2E] rounded-xl px-4 py-3 text-white placeholder:text-[#5B5C5F] focus:outline-none focus:border-[#3A80F6] focus:ring-1 focus:ring-[#3A80F6] transition-all duration-300',
